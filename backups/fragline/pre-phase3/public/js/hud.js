...
export const ACTIONS = [
  ...
  ['slot4', 'Gun slot 4 (Holdout)', 'Digit4'], ['slot5', 'Gun slot 5 (Holdout)', 'Digit5'],
  ['throw', 'Throw grenade (Holdout)', 'KeyT'], ['heal', 'Heal / shield (Holdout)', 'KeyH'],
  ['backpack', 'Backpack (Holdout)', 'KeyI'], ['dropgun', 'Drop gun (Holdout)', 'KeyZ'],
];
