...
export class Combat {
  ...
  onRocket(p, m) {
    ...
    if (w.projectile === 'grenade') return this.lob(p, [...m.o], dir, dmg, w.splash, g.el);
  ...
  // Grenade launcher round: arcs, explodes on the first thing it touches.
  lob(owner, o, dir, dmg, splash, el = null) {
    const pr = { id: this.nextId++, kind: 'glnade', pos: o, vel: [dir[0] * 30, dir[1] * 30 + 2.5, dir[2] * 30], born: Date.now(), owner, dmg, splash, el };
    this.flying.push(pr);
