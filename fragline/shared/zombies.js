...
export const ZTYPES = {
  ...
  // small flyer: circles high, screeches, dives at you, climbs back — flies over your walls
  swooper: { id: 'swooper', name: 'Swooper', weight: 0.5, hp: 60, speed: 7, scale: 0.6, dmg: 14, sdmg: 0, reach: 1.3, windup: 0.5, cooldown: 2.5, reward: 110, cost: 1.5, from: 8, flyer: true, alt: 7.5, noVariant: true },
  ...
  titan: { id: 'titan', name: 'Brood Titan', hp: 9000, speed: 1.5, scale: 4.2, dmg: 45, sdmg: 600, reach: 4.2, windup: 1.3, cooldown: 2.6, reward: 3000, cost: 0, boss: true, noVariant: true, stomp: 5.5 },
...
export function waveWeights(w, n) {
  ...
  spec('swooper', 1.2, 0.1); spec('burrower', 0.8, 0.06); spec('shield', 0.5, 0.05); spec('pyro', 0.8, 0.06); spec('frost', 0.8, 0.06);
  return W;
}
