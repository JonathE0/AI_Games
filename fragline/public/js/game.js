...
export class Game {
  ...
  setVCursor(x, y) {
    ...
    const b = document.elementFromPoint(...this.vcur)?.closest('#buyMenu button, #bagMenu button, #smithMenu button');
    if (b && !b.disabled) { b.classList.add('hover'); this.hoverEl = b; }
  }

  vClick() {
    const b = this.vcur && document.elementFromPoint(...this.vcur)?.closest('#buyMenu button, #bagMenu button, #smithMenu button');
  ...
  update(dt) {
    ...
    } else if ((this.ui === 'buy' || this.ui === 'bag' || this.ui === 'smith' || this.ui === 'map') && this.vcur && (mx || my)) {
    ...
    const moveFree = inp.locked && !this.intro && (!this.ui || this.ui === 'buy' || this.ui === 'bag' || this.ui === 'smith' || this.ui === 'map');
